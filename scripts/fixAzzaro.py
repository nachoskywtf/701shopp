...
def main():
    ...
    id_val = "azzaro-the-most-wanted-hombre-eau-de-parfum-intense-100ml-edp"
    url = "https://m.media-amazon.com/images/I/71yRR++T-sL._SL1500_.jpg"
    ...
    print("Azzaro actualizado con exito.")
